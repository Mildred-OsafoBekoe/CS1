...
points = 0 
game = input("Which game would you like to play? Numbers-1, Colors-2, or All About Me?-3").lstrip()   # Initiates and asks game
if game == "1":                                                                                       # Loop to Numbers Code
  ...
  while True:                                                                                         # Directions Loop
    answer= input("Understand? Yes or No").lstrip()
    if answer == "Yes":
      break
    elif answer == "No":
...
elif game == "3":                                                                                     # If user picks this option
  ...
  print(f"This game was just for fun, hope you liked it! You got {points}/2 right")                  # Inserts points function
